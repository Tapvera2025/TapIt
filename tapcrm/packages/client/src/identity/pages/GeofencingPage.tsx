...
export function GeofencingPage({ onBack }: { onBack: () => void }): React.JSX.Element {
  ...
  return <main className="min-h-screen bg-app-background p-6 text-app-foreground md:p-10">
    <div className="mx-auto max-w-6xl">
      ...
      <div className="page-heading mb-8"><p className="text-xs font-bold uppercase tracking-[0.16em] text-app-accent">Identity controls</p><h1 className="mt-2 font-display text-4xl font-bold tracking-[-0.05em]">Geofencing</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-app-muted">Shared locations are used only during sign-in. Employees see the assigned locations and the 90-day coordinate retention period.</p></div>
      ...
      {error && <p className="mb-4 rounded-lg border border-[#d86b6b]/30 bg-[#d86b6b]/10 px-4 py-3 text-sm text-app-danger">{error}</p>}
