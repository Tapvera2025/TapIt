...
export function IdentityLayout({ children }: { children: ReactNode }) {
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-app-background px-5 py-8 text-app-foreground [background-image:radial-gradient(circle_at_18%_12%,rgba(57,214,189,0.14),transparent_27rem),radial-gradient(circle_at_90%_90%,rgba(15,159,139,0.1),transparent_24rem)]">
