...
export const ACCESS_ERROR_CODES = {
  ...
  OVERRIDE_REASON_REQUIRED: 'ACCESS_OVERRIDE_REASON_REQUIRED',
  OVERRIDE_EXPIRY_IN_PAST: 'ACCESS_OVERRIDE_EXPIRY_IN_PAST',
  ...
  ROLE_CHANGE_TEAM_INVALID: 'ACCESS_ROLE_CHANGE_TEAM_INVALID',
  ROLE_CHANGE_TEAM_REQUIRED: 'ACCESS_ROLE_CHANGE_TEAM_REQUIRED',
  ROLE_CHANGE_SELF: 'ACCESS_ROLE_CHANGE_SELF',
  ROLE_CHANGE_REQUESTER_NOT_HR: 'ACCESS_ROLE_CHANGE_REQUESTER_NOT_HR',
  ROLE_CHANGE_HR_TARGET_FORBIDDEN: 'ACCESS_ROLE_CHANGE_HR_TARGET_FORBIDDEN',
  ROLE_CHANGE_REASON_REQUIRED: 'ACCESS_ROLE_CHANGE_REASON_REQUIRED',
  ROLE_CHANGE_NOT_AUTHORIZED: 'ACCESS_ROLE_CHANGE_NOT_AUTHORIZED',
} as const;
