...
| GET | /api/identity/geofence-appeals | `identity:manage-geofence` | — |
| POST | /api/identity/geofence-appeals/:id/decide | `identity:manage-geofence` | — |
...
| GET | /api/org/chart | `org:view-structure` | — |
...
| GET | /api/access/delegation-options/:userId | `access:delegate` | userId |
| GET | /api/access/overrides | `access:view` | — |
...
| POST | /api/users/:id/manager-reassignment | `users:manage` | id |
